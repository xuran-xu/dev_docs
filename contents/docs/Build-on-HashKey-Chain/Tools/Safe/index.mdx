---
title: Safe
description: Multi-signature wallet solutions for secure asset management on HashKey Chain
---

# Safe

Safe (formerly Gnosis Safe) is an industry-leading multi-signature wallet that provides advanced security for digital assets and smart contract interactions. HashKey Chain offers official Safe deployments for both mainnet and testnet environments.
